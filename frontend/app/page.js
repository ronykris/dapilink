  ...
  return (
    <div className="flex flex-col items-center h-screen">
      ...
      )}
      {
        loader ?         
          <div role="status">
            <svg aria-hidden="true" class="m-20 w-32 h-32 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
